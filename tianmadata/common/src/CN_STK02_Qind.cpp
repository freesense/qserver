...
BOOL CCN_STK02_Qind::Open(const char* pFileName, DWORD dwDesiredAccess, DWORD dwShareMode,
...
void CCN_STK02_Qind::Close()
{
	CBaseFile::Close();
}

BOOL CCN_STK02_Qind::Requery()
{
	char szSql[500];
	sprintf_s(szSql, 500, "SELECT CN_STK02_Qind.*,CN_STK03_Fnind.*,CN_STK04_Anst.*,CN_STK08_Ggar.*\
				   FROM CN_STK02_Qind,CN_STK03_Fnind,CN_STK04_Anst,CN_STK08_Ggar \
				   WHERE CN_STK02_Qind.SEC_CD=CN_STK03_Fnind.SEC_CD AND	CN_STK03_Fnind.SEC_CD=\
				   CN_STK04_Anst.SEC_CD AND CN_STK04_Anst.SEC_CD=CN_STK08_Ggar.SEC_CD AND \
				   CN_STK08_Ggar.Sta_prd='CUR' AND CN_STK02_Qind.IS_VLD=1 AND CN_STK03_Fnind.IS_VLD=1 \
				   AND CN_STK04_Anst.IS_VLD=1 AND CN_STK08_Ggar.IS_VLD=1");
...
/*
void CCN_STK02_Qind::LogEvent(LPCTSTR lpFormat, ...)
{
	char chMsg[200];
